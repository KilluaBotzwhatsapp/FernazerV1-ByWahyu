...
「 *INFO MENU* 」
 ...
 $
 =>`
 frnzer.send3Button(from, fernazer, `Time : ${time} ~Wahyu`, 'OWNER', `${prefix}owner`, 'SCRIPT BOT', `${prefix}sourcecode`,'INFO BOT',`${prefix}info` , { quoted: faketroli ,contextInfo: {"mentionedJid": [sender]}})
 break
 
 case 'menu':
 let tod = fs.readFileSync('./media/Fernazer.jpg')
 frnzer.sendMessage(from, { contentText: `Hai, ${userfernazer} ${ucapanWaktu}`, footerText: 'Rules Bot\n\nTlpn/Vc = Blok\n\nSosmed\ngithub: https://github.com/wahyuofc\nYt: https://youtube.com/channel/UCkra5RBdiOarRs8HeyFlviQ\n\nMy Web: https://xteam.xyz./\n Wa: https://wa.me/6283890284607\n\n©Wahyu Botz | Whatsapp', buttons: [{ buttonId: `${prefix}menu2`, buttonText: { displayText: 'MENU BOT' }, type: 1 },{ buttonId: `${prefix}loli`, buttonText: { displayText: 'LOMLI' }, type: 1 }], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: tod, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
 break
...
case 'sourcecode': 
       case 'sc': 
       case 'src':
             frnzer.sendButton(from,`Apa Mau sc?,, Di Yt Banyak Tod`,'Creator: Wahyu','KEMBALI KE MENU↩️',`${prefix}menu2`,{quoted: faketroli})
              break
case 'ttp':
case 'attp':
